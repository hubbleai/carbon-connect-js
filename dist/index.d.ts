...
declare const generateOauthurl: ({ accessToken, integrationName, chunkSize, chunkOverlap, skipEmbeddingGeneration, tags, optionalParams, environment, }: GenerateOAuthURLParams) => Promise<GenerateOAuthURLResponse>;
