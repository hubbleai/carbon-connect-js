...
declare const deleteFiles: ({ accessToken, fileIds, environment, }: DeleteFilesParams) => Promise<DeleteFileResponse>;
...
declare const submitSitemapScrapeRequest: (params: SubmitSitemapScrapeRequestParams) => Promise<SubmitScrapeRequestResponse>;
